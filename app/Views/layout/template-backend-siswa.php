...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark navbar-dark">
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
        <a onclick="return confirm('Yakin Mau Keluar..??')" class="nav-link" href="<?= base_url('auth/logouts') ?>">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= base_url('siswa') ?>" class="brand-link">
      ...
      <span class="brand-text font-weight-light">PPDB Siswa</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="info">
          <a href="#" class="d-block"><?= session()->get('nama_panggilan') ?></a>
        </div>
      </div>
      <!-- Sidebar Menu -->
      <nav class="mt-2">
